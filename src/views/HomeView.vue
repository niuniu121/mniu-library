...
const validateReasonContainWord = (blur) => {
  if (formData.value.reason.includes('friend')) {
    if (blur) reasonKeyWord.value = true
  } else {
    reasonKeyWord.value = false
  }
}
</script>
      ...
      <div class="col-md-8 offset-md-2">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            <textarea
              ...
              @input="
                () => {
                  ...
                  validateReasonContainWord(true)
                }
              "
            ></textarea>
            ...
            <div v-if="reasonKeyWord" style="color: green">Great to have a friend</div>
          </div>
          <div class="mb-3">
